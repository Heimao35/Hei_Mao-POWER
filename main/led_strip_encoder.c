...
esp_err_t rmt_new_led_strip_encoder(const led_strip_encoder_config_t *config, rmt_encoder_handle_t *ret_encoder)
{
    ...
    rmt_bytes_encoder_config_t bytes_encoder_config = {
        .bit0 = {
            .level0 = 1,
            .duration0 = (uint32_t)(0.3f * (float)config->resolution / 1000000.f),
            .level1 = 0,
            .duration1 = (uint32_t)(0.9f * (float)config->resolution / 1000000.f),
        },
        .bit1 = {
            .level0 = 1,
            .duration0 = (uint32_t)(0.9f * (float)config->resolution / 1000000.f),
            .level1 = 0,
            .duration1 = (uint32_t)(0.3f * (float)config->resolution / 1000000.f),
        },
        .flags.msb_first = 1,
    };
